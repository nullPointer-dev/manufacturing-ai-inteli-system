...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className={`${hideLogo ? 'static' : 'absolute top-[1em]'} z-[1000] ${hideLogo ? 'w-auto' : 'w-full left-0 md:w-auto md:left-auto'} ${hideLogo ? '' : 'px-4'}`}>
      <nav
      ...
      >
        ...
        <div
          ref={navItemsRef}
          className={`relative items-center rounded-full hidden md:flex ${hideLogo ? '' : 'ml-2'}`}
          style={{
            height: 'var(--nav-h)',
            background: 'var(--base, #000)'
          }}
